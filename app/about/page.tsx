    ...
    <div className="max-w-4xl mx-auto px-4 py-16 w-full">
      <div className="bg-white p-8 md:p-12 rounded-3xl border border-border shadow-sm text-center relative overflow-hidden flex flex-col items-center">
        ...
        <div className="mt-12 bg-bg-secondary w-full p-8 rounded-2xl border border-border">
          ...
          <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP || '201000000000'}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-3 bg-brand-600 text-white font-bold rounded-lg hover:bg-brand-700 transition-colors shadow-lg shadow-brand-200 uppercase tracking-widest text-sm">
